/* ============================================
   ...
   (function () {
    ...
    function actualizarUIporModo() {
      ...
      // Mostrar/ocultar información del simulacro
    ...
    function seleccionarModo(modo) {
      ...
      // Actualizar UI (cantidad y mensaje informativo)
      actualizarUIporModo();
      actualizarDisponibles();
    }
    ...
    function actualizarDisponibles() {
      ...
      if (state.modo === 'simulacro') {
        // Para simulacro, mostramos la distribución fija
      ...
      // Ajustar cantidad si excede disponibles (solo para modos que no son simulacro)
    ...
    function iniciarSesion() {
      ...
      if (state.modo === 'materia') {
        ...
        for (const [materia, cantidad] of Object.entries(distribucion)) {
          ...
          // Tomar la cantidad requerida, o todas si no hay suficientes
          const tomadas = shuffled.slice(0, Math.min(cantidad, shuffled.length));
          seleccionadas = seleccionadas.concat(tomadas);
        }
        
        // Barajar todas las preguntas seleccionadas para mezclar materias
